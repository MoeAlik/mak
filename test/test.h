...
void assert(bool val, const std::string &msg) {
  if (!val) {
    throw std::runtime_error(msg);
  }
}

void assert_not(bool val, const std::string &msg) { return assert(!val, msg); }

template <class T>
inline void assert_eq(T &lhs, T &rhs, const std::string &msg) {
  if (lhs != rhs) {
    throw std::runtime_error(msg + "\nleft: " + lhs + "\nright: " + rhs + '\n');
  }
}
...
template <class T>
inline void assert_neq(T &lhs, T &rhs, const std::string &msg);
